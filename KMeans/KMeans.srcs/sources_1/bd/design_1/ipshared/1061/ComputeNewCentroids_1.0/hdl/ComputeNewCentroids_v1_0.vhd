...
architecture Structural of StreamCopIPCore_v1_0 is
    ...
    --Cenas do exemplo do prof. Provavelmente nao vao ser uteis
    ...
    signal s_top_level_reset: std_logic := '0';
    
begin

    s_top_level_reset <= (not m00_axis_aresetn);-- or reset;
    ...
    StreamCopIPCore_v1_0_M00_AXIS_inst : StreamCopIPCore_v1_0_M00_AXIS
        ...
        port map (
            ...
            enable          => s_read_enable,
            new_centroids    => s_new_centroids,
            --new_centroids    => s_point_features(NUM_FEATURES*NUM_CENTROIDS*32-1 downto 0),
            sample_reset => reset
        );
    ...
    TopLevel: entity work.TopLevel 
        ...
        port map(
            clk => s00_axis_aclk,
            reset => s_top_level_reset,
            enable => s_validData,
            pickCentroidEnable => s_pickCentroidEnables,
            finished => finished,
            finished_delay => s_read_enable,
            point_features => s_point_features,
            centroid_features => s_centroid_features,
            new_centroids => s_new_centroids
        );
